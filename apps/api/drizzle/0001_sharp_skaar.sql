...
--> statement-breakpoint
ALTER TABLE "debts" DROP CONSTRAINT "debts_account_id_accounts_id_fk";
--> statement-breakpoint
...
DROP INDEX "debts_account_id_idx";--> statement-breakpoint
ALTER TABLE "accounts" ADD COLUMN "bank_id" uuid NOT NULL;--> statement-breakpoint
ALTER TABLE "transactions" ADD COLUMN "currency_balance_id" uuid NOT NULL;--> statement-breakpoint
ALTER TABLE "transactions" ADD COLUMN "cashback_amount" numeric(12, 2) DEFAULT '0';--> statement-breakpoint
ALTER TABLE "transactions" ADD COLUMN "to_currency_balance_id" uuid;--> statement-breakpoint
ALTER TABLE "debts" ADD COLUMN "currency_balance_id" uuid NOT NULL;--> statement-breakpoint
...
ALTER TABLE "accounts" DROP COLUMN "is_cash";--> statement-breakpoint
...
ALTER TABLE "accounts" DROP COLUMN "color";--> statement-breakpoint
ALTER TABLE "accounts" DROP COLUMN "is_archived";--> statement-breakpoint
...
ALTER TABLE "debts" DROP COLUMN "account_id";--> statement-breakpoint
