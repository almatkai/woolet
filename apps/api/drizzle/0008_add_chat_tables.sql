...
ALTER TABLE "categories" ADD COLUMN "type" text DEFAULT 'income' NOT NULL;--> statement-breakpoint
ALTER TABLE "stocks" ADD COLUMN "is_manual" boolean DEFAULT false NOT NULL;--> statement-breakpoint
