...
export function DebtsWidget({ gridParams }: { gridParams?: GridParams }) {
    ...
    return (
        <Card className={cn('dashboard-widget h-full flex flex-col group rounded-[32px] overflow-hidden', isCompact && 'dashboard-widget--compact')}>
            <Link to="/debts" className="block flex-1 flex flex-col min-h-0">
            ...
            <WidgetFooter>
                ...
                <Link to="/debts" className="text-[9px] font-bold text-primary flex items-center gap-0.5 hover:underline uppercase tracking-wider">
