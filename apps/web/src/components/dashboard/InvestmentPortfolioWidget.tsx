    ...
    return (
        <Card className={cn('dashboard-widget h-full flex flex-col group rounded-lg overflow-hidden', isCompact && 'dashboard-widget--compact')}>
                <CardHeader className="p-3 pb-1 flex flex-row items-start justify-between hover:bg-muted/30 transition-colors rounded-t-lg cursor-pointer">
                    <div className="flex flex-col min-w-0 flex-1">
                        ...
                        <div className="flex items-baseline gap-2 flex-wrap">
                            <span className="text-lg font-bold tracking-tight whitespace-nowrap">
                                <CurrencyDisplay amount={totalValue} abbreviate={totalValue >= 1000} />
                            </span>
                            <div className={cn(
                    ...
                    <div className="p-1.5 bg-blue-500/10 rounded-sm group-hover:bg-blue-500/20 transition-colors">
                    ...
                    <div className="flex-1 space-y-1.5 overflow-hidden py-1">
                        {holdings.length === 0 ? (
                            ...
                            visibleHoldings.map((holding: any) => (
                                <div key={holding.stockId} className="flex items-center justify-between gap-2 p-1.5 rounded-sm bg-muted/40 hover:bg-muted/60 transition-colors group/item">
