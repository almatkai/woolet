...
import { TrendingUp, TrendingDown, ArrowUpRight, DollarSign, Calendar, ArrowRight } from 'lucide-react';
                    ...
                    <div className="flex flex-col min-w-0 flex-1">
                        ...
                        <div className="flex items-baseline gap-1.5 flex-wrap">
                            <span className="text-lg sm:text-xl font-bold tracking-tight text-emerald-600 dark:text-emerald-500 whitespace-nowrap">
                                <CurrencyDisplay amount={totalIncome} showSign abbreviate={totalIncome >= 1000} />
                            </span>
                            <div className={cn(
                    ...
                    {isTall && transactions.length > 0 && (
                        <div className="mt-2 space-y-1 overflow-hidden relative z-10">
                            {transactions.slice(0, 2).map(tx => (
                                <div key={tx.id} className="flex items-center justify-between p-1.5 rounded-sm bg-background/60 backdrop-blur-sm border border-emerald-500/10">
