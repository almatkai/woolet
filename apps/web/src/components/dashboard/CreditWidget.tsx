                    ...
                    <div className="flex flex-col min-w-0 flex-1">
                        ...
                        <div className="flex items-baseline gap-2 flex-wrap">
                            <span className="text-lg font-bold tracking-tight whitespace-nowrap">
                                <CurrencyDisplay amount={monthlyPayment} currency={settings?.defaultCurrency || "USD"} abbreviate={monthlyPayment >= 1000} />
                    ...
                    <div className="flex-1 space-y-1.5 overflow-hidden py-1">
                        {activeCredits.length === 0 ? (
                            ...
                            visibleCredits.map((credit: any) => {
                                ...
                                return (
                                    <div key={credit.id} className="flex items-center justify-between gap-2 p-1.5 rounded-sm bg-muted/40 hover:bg-muted/60 transition-colors group/item">
